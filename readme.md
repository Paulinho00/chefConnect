...
- Pełna integracja z Analytics-Service - zdążyliśmy zaimplementować analytics-service oraz zintegrować go z innymi mikroserwisami (reservations-service), tak aby wysyłały dane do kolejki SQS, natomiast nie zdążyliśmy zintegrować analityki z naszym frontendem webowym. Planowaliśmy wyświetlać wykresy oraz statystyki dla menadżera
